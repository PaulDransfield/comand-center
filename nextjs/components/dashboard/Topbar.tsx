...
//
// The TOP NAVIGATION BAR â€” visible on every dashboard page.
// Contains:
...
export default function Topbar() {
  ...
  const switcherLabel = biz.isAggregate
    ...
    : biz.current?.name ?? 'Select businessâ€¦'
    ...
    <header style={S.bar}>
      ...
      <div style={{ position: 'relative' }}>
        ...
        >
          ...
          {biz.isAggregate && <span style={{ fontSize: 14 }}>âŠž</span>}

          <span style={S.switcherLabel}>{switcherLabel}</span>
          <span style={{ fontSize: 10, opacity: .6, marginLeft: 2 }}>â–¼</span>
        </button>
          ...
          <>
            ...
            <div style={S.dropdown}>
              ...
              {biz.canAggregate && (
                ...
                >
                  <span style={{ fontSize: 14 }}>âŠž</span>
                  <div>
                    <div style={S.dropName}>All businesses</div>
                    <div style={S.dropMeta}>{biz.businesses.length} locations Â· Group view</div>
                  </div>
                  {biz.isAggregate && <span style={S.checkmark}>âœ“</span>}
                </button>
              )}
              ...
              {filtered.map(b => (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={S.dropMeta}>{b.type ?? 'Restaurant'}{b.city ? ` Â· ${b.city}` : ''}</div>
                  </div>
                  {!biz.isAggregate && biz.currentId === b.id && (
                    <span style={S.checkmark}>âœ“</span>
                  )}
                </button>
              ))}
