-- ═══════════════════════════════════════════════════════════════════════
-- P2.0 voucher back-fill + rebate guard — DRY RUN
-- ═══════════════════════════════════════════════════════════════════════
--
-- Paste this entire file into Supabase SQL Editor and Run. The wrapper
-- is BEGIN…ROLLBACK so every UPDATE/INSERT is auto-discarded at the end
-- regardless of what the verification SELECTs show. Use this to eyeball
-- the verification output, compare to dry-run-predicted figures, and
-- only THEN paste the APPLY version (identical body, trailing COMMIT).
--
