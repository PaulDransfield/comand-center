...
// No fallback DSN — hardcoded DSNs leak events from any build that
// forgets to set the env var (forks, preview envs without secrets).
// If env var is missing, Sentry is disabled entirely via `enabled`
// below; errors go to server logs instead of the wrong destination.
