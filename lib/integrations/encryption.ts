...
//   IV:      12 random bytes (initialisation vector — different for every encryption)
...
export function decrypt(encryptedBase64: string | null | undefined): string | null {
  ...
  try {
    ...
    throw new Error('Decryption failed — data may be corrupted or the encryption key has changed')
  }
}
